...
pycodestyle --max-line-length=100 --exclude=digital_filters.py,filter_examples.py,iq_io_example.py,moving_average_filter.py,digitization.py,fsk_example.py,pysdr_pulse_shaping.py,pysdr_*.py,simple_symbol_sync.py,costas_loop.py,rotate_poc.py,shmelstone_*.py,*poc.py ./
if [ $? -ne 0 ]
then
