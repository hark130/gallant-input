"""Defines AIS specific constant values."""
...
# See: https://www.navcen.uscg.gov/ais-binary-broadcast-message8
AIS_PAYLOAD_MAX_SLOTS: Final[int] = 5   # Maximum AIS payload slots for variable length data
