...
class QPSK(Modem):
    """Modulate and demodulate QPSK digital signals."""

    # CORE METHODS

    def __init__(self, config: QPSKConfig):
        """Class ctor.
...
# pylint: enable = duplicate-code
    ...
    def _parse(self) -> None:
        """Parse user input."""
        self._parse_abc()
        self._parse_qpsk_config()  # Get the rest of the data from the child object

    def _parse_qpsk_config(self) -> None:
