"""Defines the root GAIN Functional Test Class.

Import RootFuncTest for more details and usage instructions.

    Typical usage example:

    from test.root_func_test import RootFuncTest

    class GainCompTest(RootSystemTest):
...
class RootFuncTest(TediousFuncTest):
    """GAIN base functional test class.
