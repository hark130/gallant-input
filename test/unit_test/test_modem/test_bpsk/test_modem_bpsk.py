"""Defines the root BPSK() unit test class.

ModemBPSKUnitTest is the parent class for all modem.bpsk BPSK unit test classes.

    Typical usage example:

    from my_module_to_test import my_function_to_test as my_function
    from test.unit_test.test_modem.test_modem_bpsk.test_modem_bpsk import ModemBPSKUnitTest

    class ModemSomethingUnitTest(ModemBPSKUnitTest):
...
class ModemBPSKUnitTest(ModemUnitTest):
    """Parent class for all BPSK method unit tests.
