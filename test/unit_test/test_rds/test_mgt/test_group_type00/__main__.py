"""Defines the logic for running all rds.mgt RDSMsgGroupType00 unit tests as a module.
...
if __name__ == '__main__':
    ...
    sys.exit(not load_and_run('test/unit_test/test_rds/test_mgt/test_group_type00'))
