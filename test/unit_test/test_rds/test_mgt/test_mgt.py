...
class RDSMsgGrpTypeUnitTest(RDSUnitTest):
    ...
    # GOOD GROUP 4: KONO 101.1 FM Live Capture of Group Type 02A - Radio Text "KONO"
    GOOD_GRP4_MSG02_BLOCK_A0 = bytes('00110110010110001000011011', 'utf-8')  # PICode
    GOOD_GRP4_MSG02_BLOCK_B0 = bytes('00100000111000000010101001', 'utf-8')  # Offset 0
    GOOD_GRP4_MSG02_BLOCK_C0 = bytes('01001011010011111100010000', 'utf-8')  # CHAR A & B: "KO"
    GOOD_GRP4_MSG02_BLOCK_D0 = bytes('01001110010011110001100000', 'utf-8')  # CHAR C & D: "NO"
    # GOOD GROUP 5: KONO 101.1 FM Live Capture of Group Type 02A - Radio Text " 101"
    GOOD_GRP5_MSG02_BLOCK_A1 = bytes('00110110010110001000011011', 'utf-8')  # PICode
    GOOD_GRP5_MSG02_BLOCK_B1 = bytes('00100000111000010100010000', 'utf-8')  # Offset 1
    GOOD_GRP5_MSG02_BLOCK_C1 = bytes('00100000001100011000000110', 'utf-8')  # CHAR A & B: " 1"
    GOOD_GRP5_MSG02_BLOCK_D1 = bytes('00110000001100010111010001', 'utf-8')  # CHAR C & D: "01"
    ...
    # GOOD GROUP 3: Station Name "KONO" Offset 1 "NO"
    GOOD_GROUP3_MSG00_OFF1 = GOOD_GRP3_MSG00_BLOCK_A1 + GOOD_GRP3_MSG00_BLOCK_B1 \
        + GOOD_GRP3_MSG00_BLOCK_C1 + GOOD_GRP3_MSG00_BLOCK_D1
    # GOOD GROUP 4: Radio Text "KONO 101.1 San Antonio's Greatest Hits" Offset 0 "KONO"
    GOOD_GROUP4_MSG02_OFF0 = GOOD_GRP4_MSG02_BLOCK_A0 + GOOD_GRP4_MSG02_BLOCK_B0 \
        + GOOD_GRP4_MSG02_BLOCK_C0 + GOOD_GRP4_MSG02_BLOCK_D0
    # GOOD GROUP 5: Radio Text "KONO 101.1 San Antonio's Greatest Hits" Offset 1 " 101"
    GOOD_GROUP5_MSG02_OFF1 = GOOD_GRP5_MSG02_BLOCK_A1 + GOOD_GRP5_MSG02_BLOCK_B1 \
        + GOOD_GRP5_MSG02_BLOCK_C1 + GOOD_GRP5_MSG02_BLOCK_D1
