...
class RDSPICodeUnitTest(RDSUnitTest):
    ...
    GOOD_SET2_GRP01_MSG02_OFF15 = \
        ...
        b'0010000000100000000000000000100000001000000011011100'  # "    "
    # GOOD SET 3: Partial WAYFM set from 5.03: Group Type 02A - Radio Text with '\r'?!
    GOOD_SET3_GRP01_MSG02_OFF00 = \
        b'0101011100011101010101110000100001001000000000101100' \
        b'0101011101100001011101100101111001010001100001101010'  # "WayF?"
    GOOD_SET3_GRP02_MSG02_OFF01 = \
        b'0101011100011101010101110000100001001000010110010101' \
        b'0100110100100000011011110101010101011100001010111011'  # "M Up"
    GOOD_SET3_GRP03_MSG02_OFF02 = \
        b'0101011100011101010101110000100001001000101101011110' \
        b'0110110001101001000100001101100110011101000000100110'  # "lift"
    GOOD_SET3_GRP04_MSG02_OFF03 = \
        b'0101011100011101010101110000100001001000111011100111' \
        b'0110100101101110100111100101100111001011101100000011'  # "ing."
    GOOD_SET3_GRP05_MSG02_OFF04 = \
        b'0101011100011101010101110000100001001001001101110001' \
        b'0010000001010101111010101101110000011000101001110101'  # " Upb"
    GOOD_SET3_GRP06_MSG02_OFF05 = \
        b'0101011100011101010101110000100001001001011011001000' \
        b'0110010101100001001100010101110100001011100101101100'  # "eat."
    GOOD_SET3_GRP07_MSG02_OFF06 = \
        b'0101011100011101010101110000100001001001100000000011' \
        b'0010000001010010100011110101100101011000010000011001'  # " Rea"
    GOOD_SET3_GRP08_MSG02_OFF07 = \
        b'0101011100011101010101110000100001001001110110111010' \
        b'0110110000101110011110001000100000000011011111111100'  # "l. \r"
    ...
    # GOOD SET 3: Partial(?) WAYFM set from 5.03: Group Type 02A - Radio Text
    # 'WayFM Uplifting. Upbeat. Real. \r'
    GOOD_SET3_MSG02A = \
        GOOD_SET3_GRP01_MSG02_OFF00 + GOOD_SET3_GRP02_MSG02_OFF01 \
        + GOOD_SET3_GRP03_MSG02_OFF02 + GOOD_SET3_GRP04_MSG02_OFF03 \
        + GOOD_SET3_GRP05_MSG02_OFF04 + GOOD_SET3_GRP06_MSG02_OFF05 \
        + GOOD_SET3_GRP07_MSG02_OFF06 + GOOD_SET3_GRP08_MSG02_OFF07

    # GOOD SET RESULTS
    GOOD_SET1_STATION_NAME = 'KONO    '
    GOOD_SET2_RADIO_TEXT = "KONO 101.1 San Antonio's Greatest Hits                          "
    GOOD_SET3_RADIO_TEXT = 'WayFM Uplifting. Upbeat. Real. \r'
