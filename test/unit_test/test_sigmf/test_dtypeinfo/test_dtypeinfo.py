"""Defines the root SigMFDTypeInfo unit test class.

SigMFDTypeInfoUnitTest is the parent class for all ais.block SigMFDTypeInfo unit test classes.

    Typical usage example:

    from my_module_to_test import my_function_to_test as my_function
    from test.unit_test.test_ais.test_ais_block.test_ais_block import SigMFDTypeInfoUnitTest

    class SigMFDTypeInfoFuncUnitTest(SigMFDTypeInfoUnitTest):
...
class SigMFDTypeInfoUnitTest(SigMFUnitTest):
    """Parent class for all SigMFDTypeInfo method unit tests.
    ...
    def create_test_obj(self) -> SigMFDTypeInfo:
        """Create a SigMFDTypeInfo() test object."""
        return SigMFDTypeInfo(*self._args, **self._kwargs)
