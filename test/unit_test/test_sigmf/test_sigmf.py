"""Defines the root sigmf sub-package unit test class.

SigMFUnitTest is the parent class for sigmf ais sub-package related unit test classes.
    ...
    class SigMFSomethingUnitTest(SigMFUnitTest):
...
class SigMFUnitTest(RootUnitTest):
    """Parent class for all sigmf sub-package specific unit tests.
